...
<div id="large-header" class="large-header login-page">
    ...
    <div class="login-form">
        <div class="login-content">
            ...
            <form method="post" action="${pageContext.request.contextPath}/user/regist" role="form" id="form_login" class="login_padding">
                ...
                <form method="post" role="form" id="" class="login_padding">
                    <div class="form-group clearfix">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="user_name" id="password" placeholder="昵称" autocomplete="off">
                        </div>
                    ...
                    <div class="form-group">
                        <input href="javascript:;" type="submit" class="btn btn-danger btn-block btn-login" value="注册" >
